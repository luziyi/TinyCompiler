...
FSM CREATE_NFA() {
    ...
    NFA.addNode(new FSM_Node(7, TokenCode::UNDIFNIE, false));  // 过渡节点（0）
    NFA.addNode(
        new FSM_Node(8, TokenCode::UNDIFNIE, false));  // 过渡节点（0/num.）
    NFA.addNode(
        new FSM_Node(9, TokenCode::UNDIFNIE, false));       // 过渡节点（num）
    NFA.addNode(new FSM_Node(10, TokenCode::FLOAT, true));  // 浮点数
    ...
    NFA.addTrans(0, 7, zeroList);
    NFA.addTrans(0, 9, numList);
    NFA.addTrans(9, 9, numList);
    NFA.addTrans(9, 9, zeroList);
    NFA.addTrans(9, 8, pointList);
    NFA.addTrans(7, 8, pointList);
    NFA.addTrans(8, 8, zeroList);
    NFA.addTrans(8, 8, numList);
    NFA.addTrans(8, 10, zeroList);
    NFA.addTrans(8, 10, numList);
    NFA.addTrans(3, 10, pointList);
    NFA.addTrans(1, 10, pointList);
    NFA.addTrans(
        8, 7,
        numList);  // 添加从节点 7 到节点 8 的转移，允许处理小数点后的数字部分
    NFA.addTrans(
        8, 9,
        numList);  // 添加从节点 8 到节点 9 的转移，允许处理小数点后的数字部分
    NFA.addTrans(
        8, 7,
        zeroList);  // 添加从节点 7 到节点 8 的转移，允许处理小数点后的数字部分
    NFA.addTrans(
        8, 9,
        zeroList);  // 添加从节点 8 到节点 9 的转移，允许处理小数点后的数字部分
    NFA.addTrans(10, 10, numList);   // 允许浮点数的小数部分有多位数字
    NFA.addTrans(10, 10, zeroList);  // 允许浮点数的小数部分有多位数字
    return NFA;
}
